        ...
        <ul class="nav">
            ...
            <c:if test="${sessionScope.acc != null}">
                ...
                <c:if test="${sessionScope.acc.phanquyen==1 || sessionScope.acc.phanquyen==0}">
                   ...
                   <li class="active "><a class="nav-link js-scroll-trigger "  href="phieuxuat"><i class="nc-icon nc-paper"></i> PHIEU XUAT</a></li>
                </c:if>
                <c:if test="${ sessionScope.acc.phanquyen==0}">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Quản lý phiếu xuất</a>
          </div>
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link btn-rotate" href="javascript:;" data-toggle="modal" data-target="#myModaleadd">
                    <i class="nc-icon ${detail.maphieuxuat!=null? "nc-settings" : "nc-simple-add"}" style="font-size: 25px;margin-left:10px;color: #FF9500;"></i>
                </a>
              </li>
            </ul>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table class="table table-striped table-hover" style="display: block;overflow-x: auto;white-space: nowrap;">
                    ...
                    <tbody>
                        <c:forEach items="${listAllPX}" var="o">
                            <tr>
                                <td>
                                    <a href="phieuxuat?delete=${o.maphieuxuat}"><i class="nc-icon nc-box"  onclick="if(confirm('Bạn có chắc chắn xóa không?')) return true; else return false;" style="font-size: 25px;color:red;"></i></a>
                                </td>
...
<!--                    <div class="hint-text">Showing <b>5</b> out of <b>25</b> entries</div>-->
                     <ul class="pagination">
                        <li class="page-item"><a class="page-link" ${tag <= 1?"hidden":"" } href="phieuxuat?index=1"> << </a></li>
                        <li class="page-item"><a class="page-link" ${tag <= 1?"hidden":""} href="phieuxuat?index=${listLui}"> < </a></li>
                        <c:forEach begin="1" end="${andP}" var="i">
                           <li class="page-item"><a class="page-link ${tag == i?"active":""}" href="phieuxuat?index=${i}">${i}</a></li>
                        </c:forEach>
                        <li class="page-item"> <a class="page-link" ${tag >= andP?"hidden":""} href="phieuxuat?index=${listTien}"> > </a></li>
                        <li class="page-item"> <a class="page-link" ${tag >= andP?"hidden":""} href="phieuxuat?index=${andP}"> >> </a></li>
            </ul>
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <div class="section-txt" align=center>
              <h2 style="position:relative; right:200px;">PHIEUXUAT ${detail.makh!=null? "EDIT" : "ADD"} </h2>
            </div>
          </div>
          ...
          <div class="modal-body">
                    ...
                    <form action="phieuxuat?action=add"  method="post" style="color:black;padding-left: 90px;padding-right: 90px;" >
                            
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>Mã phiếu xuất</label>
                                        <input name="maphieuxuat" type="text" value="${ maxID}" class="form-control" readonly  required  >
                                    </div>
                                    <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div id="content1">
                                            <input name="makhachhang" type="text" list="khachhang" value="" class="form-control"  required  >
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="manhanvienlap" type="text" list="nhanvien" value="${sessionScope.acc.manv}" class="form-control" readonly required  >
                             ...
                             <div class="form-group">
                                ...
                                <input name="ngaylap" type="date" value="" class="form-control"  required  >
                            </div>
                            
                             <div class="form-group">
                                <label>Diễn giải</label>
                                <textarea name="diengiai" class="form-control" required style="height: 100px;"></textarea>
                            </div>
